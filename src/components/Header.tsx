    ...
    return (
        <div className="my-10 mx-15x flex-1 grid grid-cols-1">
            ...
            <div className="w-3/4 mx-auto py-8 flex gap-3">
                ...
                <input type="text" id="task" placeholder="Digite uma nova tarefa" className="border flex-1 border-black rounded-3xl resize-none text-2xl px-4 focus:outline-none"></input>
            </div>
